...
package filesystempbconnect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	filesystem "github.com/xerpa-ai/e2b-go/internal/proto/filesystem"
	http "net/http"
	strings "strings"
)
...
func NewFilesystemClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) FilesystemClient {
	...
	filesystemMethods := filesystem.File_internal_proto_filesystem_filesystem_proto.Services().ByName("Filesystem").Methods()
